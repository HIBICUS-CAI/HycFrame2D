...
void RegisterStoryAction(ObjectFactory* _factory)
{
    ...
    uInitPool->insert(std::make_pair(
        FUNC_NAME(StoryLoadFadeInit), StoryLoadFadeInit));
    uUpdatePool->insert(std::make_pair(
        FUNC_NAME(StoryLoadFadeUpdate), StoryLoadFadeUpdate));
    uDestoryPool->insert(std::make_pair(
        FUNC_NAME(StoryLoadFadeDestory), StoryLoadFadeDestory));
    uInputPool->insert(std::make_pair(
        FUNC_NAME(StoryUiInput), StoryUiInput));
}
